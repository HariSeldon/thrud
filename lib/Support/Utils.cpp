...
//
////  llvm::errs() << "ReplaceInAdd:\n";
////  AddExpr->dump();
//
//  SmallVector<const SCEV *, 8> Operands;
//  for (SCEVAddExpr::op_iterator I = AddExpr->op_begin(), E = AddExpr->op_end();
//       I != E; ++I) {
//    const SCEV *NewOperand = NULL;
//
//    // Manage Constants.
//    if (const SCEVConstant *ConstSCEV = dyn_cast<SCEVConstant>(*I)) {
//      NewOperand = ConstSCEV;
//    }
//
//    // Manage Multiplications.
//    if (const SCEVMulExpr *MulSCEV = dyn_cast<SCEVMulExpr>(*I)) {
//      NewOperand = ReplaceInMul(SE, MulSCEV, TIds, value);
//    }
//
//    // Manage Unknown.
//    if (const SCEVUnknown *UnknownSCEV = dyn_cast<SCEVUnknown>(*I)) {
//      Value *V = UnknownSCEV->getValue();
//      if (IsPresent<Value>(V, TIds)) {
//        NewOperand = SE->getConstant(value);
//      } else {
//        NewOperand = UnknownSCEV;
//      }
//    }
//
...
//  }
//
////  for (SmallVector<const SCEV*, 8>::iterator I = Operands.begin(), E = Operands.end();
////       I != E; ++I) {
////    llvm::errs() << "Operand:";
////    SE->getEffectiveSCEVType((*I)->getType())->dump();
////    llvm::errs() << "\n";
////  }
//  const SCEV *result = SE->getAddExpr(Operands);
//
////  llvm::errs() << "Replace in Add result: ";
////  result->dump();
//
//  return result;
//}
...
//                         ValueVector &TIds, const APInt &value) {
//
//  llvm::errs() << "ReplaceInMul:\n";
//  MulExpr->dump();
//
//  SmallVector<const SCEV *, 8> Operands;
//  for (SCEVAddExpr::op_iterator I = MulExpr->op_begin(), E = MulExpr->op_end();
//       I != E; ++I) {
//    const SCEV *NewOperand = NULL;
//
//    // Manage Constants.
...
//
//    // Manage Multiplications.
//    if (const SCEVAddExpr *AddSCEV = dyn_cast<SCEVAddExpr>(*I)) {
//      NewOperand = ReplaceInAdd(SE, AddSCEV, TIds, value);
//    }
//
//    // Manage Unknown.
//    if (const SCEVUnknown *UnknownSCEV = dyn_cast<SCEVUnknown>(*I)) {
...
////  }
//
//  const SCEV *result = SE->getMulExpr(Operands);
//  return result;
//}
//
////------------------------------------------------------------------------------
//const SCEV *ReplaceInDiv(ScalarEvolution *SE, const SCEVUDivExpr *DivExpr,
//                         ValueVector &TIds, const APInt &value) {
//  llvm::errs() << "ReplaceInDiv:\n";
//  DivExpr->dump();
//
//  
//
...
//
////------------------------------------------------------------------------------
//const SCEV* ReplaceInExpr(ScalarEvolution *SE, const SCEVExpr *Expr,
//                          ValueVector &TIds, const APInt &value) {
//  
//}
//
...
////
//////------------------------------------------------------------------------------
////int AnalyzeMultiplication(ScalarEvolution *SE, const SCEVNAryExpr *Scev,
////                          ValueVector &TIds) {
